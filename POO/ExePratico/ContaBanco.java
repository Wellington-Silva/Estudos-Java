...
public class ContaBanco {
    ...
    public void fecharConta() {
        if(this.getSaldo() > 0) {
            System.out.println("A conta não pode ser fechada pois ainda possui dinheiro");
    ...
    public void depositar(float valor) {
        if(this.isStatus() == true) {
            ...
            System.out.println("Deósito realizado na conta de " + this.getDono());
        } else {
    ...
    public void pagarMensal() {
        ...
        if(this.isStatus()) {
            ...
            System.out.println("Impossível pagar uma cont fechada");
        }
    }
}
